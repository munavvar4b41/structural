...
class RequirementReviewUnderstandingSubmittedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'type' => 'requirement_review_understanding_submitted',
            'project_requirement_id' => $this->requirement->id,
            'project_id' => $project->id,
            'title' => __('Review understanding submitted: :requirement', ['requirement' => $this->requirement->title]),
