    ...
    public function test_team_head_can_store_case_study_with_task_link(): void
    {
        ...
        $this->actingAs($head)
            ->post(route('admin.projects.case-studies.store', $project), [
                ...
                'client_issue' => $this->tipTapJson('Manual exports took hours'),
                'business_impact' => $this->tipTapJson('Delayed client decisions'),
                'solution_discovery' => $this->tipTapJson('Mapped reporting workflow'),
                'proposed_solution' => $this->tipTapJson('Automated dashboard'),
                'implementation' => $this->tipTapJson('Built scheduled exports'),
                'resolution' => $this->tipTapJson('Reports now run automatically'),
