            ...
            <div>
                ...
                <div :class="cn('relative min-w-[12rem] flex-1 sm:max-w-sm', props.inputClass)">
                    <Search
                        ...
                        aria-hidden="true" />
                    <Input id="search-input" v-model="localSearch" type="search" :placeholder="placeholder" class="h-9 pl-9 pr-9"
                        autocomplete="off" aria-label="Search" />
                    <Button v-if="localSearch !== ''" type="button" variant="ghost" size="icon"
